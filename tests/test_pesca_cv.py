...
class PescaCvParserTests(unittest.TestCase):
    def test_filters_noise_and_collapses_consecutive_national_days(self):
        ...
        rows.append(
            "<tr><td>29/11/2026</td><td>A091</td><td>C.P. HORADADA</td><td>SOCIAL CLASIF.</td><td>MAR COSTA</td><td>GUARDAMAR</td><td>ALICANTE</td><td>PLAYA *</td></tr>"
        ...
        self.assertEqual(event["end"], "2026-11-28")
