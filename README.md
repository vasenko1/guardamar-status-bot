...
35 19 1-20 9 * /path/to/TelegramBot/termux/sync-bathing-water.sh
...
- `termux/sync-guide.sh` at 09:02 to read the bounded places/activities
  ...
  20 September, reads only the official bathing-zone programme, and downloads a
...
35 19 1-20 9 * /data/data/com.termux/files/home/bots/guardamar-status/termux/sync-bathing-water.sh
...
the dedicated 19:35 bathing-zone check from 1 June through 20 September,
