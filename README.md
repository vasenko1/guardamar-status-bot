...
- one short-lived process invoked externally at 07:30
...
Use an external Termux scheduler to invoke this command at `07:30` in
...
30 7 * * * cd /path/to/TelegramBot && bash -lc 'source .env; PYTHONPATH=src python -m telegrambot run'
```
...
execution; remove that line if battery use is more important than exact 07:30
delivery.
