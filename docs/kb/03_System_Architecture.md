...
1. **External 10:00 trigger** starts one short-lived digest process.
...
- One direct collection pass during the 10:00 execution
...
The external Termux scheduling mechanism invokes the command at 10:00 in
